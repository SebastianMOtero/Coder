...
const routerProductos: express.Router = express.Router();
const routerCarrito: express.Router = express.Router();
...
routerCarrito.get("/listar/:id", (req: express.Request, res: express.Response) => {

});

routerCarrito.post("/agregar/:id_producto", (req: express.Request, res: express.Response) => {

});

routerCarrito.delete('/borrar/:id', (req: express.Request, res: express.Response) => {
